...
//#ifdef GUS
	#define SIZE 250
	#define HOMED_HEIGHT 201
	#define HUB_Z 121.0
	#define SHOULDER_ZA 27.0
	#define SHOULDER_ZB 27.0
	#define SHOULDER_ZC 27.0
	#define MAX_LENGTH_A 327 
	#define MAX_LENGTH_B 327
	#define MAX_LENGTH_C 327
...
#define ASPU 270
#define DEFAULT_AXIS_STEPS_PER_UNIT   {ASPU, ASPU, ASPU, 145.5}  // default steps per unit for GUS (GT2, 20 tooth)
